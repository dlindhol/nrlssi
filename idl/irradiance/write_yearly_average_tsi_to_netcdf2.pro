;@***h* SOLAR_IRRADIANCE_FCDR/write_yearly_average_tsi_to_netcdf.pro
; 
; NAME
;   write_yearly_average_tsi_to_netcdf.pro
;
; PURPOSE
;   The write_yearly_average_tsi_to_netcdf.pro function writes the date and yearly-averaged Model Total Solar Irradiance
;   to a netcdf4 file. It is called by the function average_by_year.pro
;
; DESCRIPTION
;   The write_yearly_average_tsi_to_netcdf.pro function writes the yearly-averaged Model Total Solar Irradiance, and (midpoint) 
...
function write_yearly_average_tsi_to_netcdf2, y1, y2, algver, result, file
  ...
  NCDF_ATTPUT, id, /GLOBAL, "title", "Yearly Averaged TSI calculated using NRL2 solar irradiance model"
  ...
  NCDF_ATTPUT, id, /GLOBAL, "time_coverage_start", y1
  NCDF_ATTPUT, id, /GLOBAL, "time_coverage_end", y2
  ...
  NCDF_ATTPUT, id, x1id, 'long_name', 'NOAA Fundamental Climate Data Record of Yearly Averaged Total Solar Irradiance (Watt/ m**2)'
