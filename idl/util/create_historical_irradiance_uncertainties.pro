...
cycle = process_irradiance('1882-01-01', '2014-12-31', final=final, time_bin='year',/cycle)

;judith_hist_irrad=get_historical_tsi('1882', '2014', /cycle) ;judith cycle only data (served by LaTiS)
...
cycle_hist = get_historical_tsi('1610','1880',/cycle) ;Doug is working on fixing time bound ranges: for now this provides through 1881
...
cycle_and_background = get_historical_tsi('1610', '1880') ;judith cycle + background data (served by LaTiS) (PLUS, see note above re tme bound ranges)
...
;make a plot
p1=plot(cycle_hist.time,background,'-r',name='Background Uncertainty',xtitle='Time',ytitle='TSI Unc')
p2=plot(cycle_hist.time,cycle_unc,'-b',overplot=1,name='Cycle Uncertainty')
p3=plot(cycle_hist.time,total_unc,'-k',name='Total (background+cycle) Uncertainty',overplot=1)
...
;save,filename='/Users/hofmann/git/nrlssi/data/NRL2_historical_model_parameters_v02r00.sav',struct,/verb
...
;
;judith=read_ascii('/Users/hofmann/Desktop/NRLTSI2_1610_2014a_22Jun15.txt')
